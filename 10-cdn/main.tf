...
resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              =  "web-${var.environment}.${var.zone_name}"#web-dev.venkatdevops1608.online
  ...
  aliases = ["web-${var.common_tags.Component}.${var.zone_name}"]#web-cdn.venkatdevops1608.online
...
module "records" {
  ...
  records = [
    {
      name    = "web-cdn" #web-cdn.venkatdevops1608.online
      type    = "A"
